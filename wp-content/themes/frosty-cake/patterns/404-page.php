 ...
 * 404 Section
 * 
 * slug: frosty-cake/404-page
 * title: 404 Page
 * categories: frosty-cake
 */

return array(
    'title'      =>__( '404 Page', 'frosty-cake' ),
...
<p class="has-text-align-center has-content-heading-font-size"><strong>'. esc_html('Unfortunately we can’t find that page.','frosty-cake') .'</strong></p>
<!-- /wp:paragraph -->

<!-- wp:paragraph {"align":"center"} -->
<p class="has-text-align-center">'. esc_html('The page you are looking for doesnt exist or has been moved. Try another url or go to the site homepage.','frosty-cake') .'</p>
<!-- /wp:paragraph --></main>
<!-- /wp:group -->',
);